...
<template>
    <nav id="navbar" class="fixed z-50 mx-auto flex gap-4 md:gap-12 flex-nowrap justify-center w-[100vw] overflow-scroll py-5">
        ...
        <RouterLink @click="handleNavClick('/news')"
            :class="activeRoute.includes('/news') ? 'bg-red-600 rounded-3xl px-4 py-2' : 'px-4 py-2 text-nowrap'" to="/news">
            <span class="text-white text-xs md:text-md line-clamp-1 !text-nowrap">News</span>
        </RouterLink>
        <RouterLink @click="handleNavClick('/sport')"
            :class="activeRoute.includes('/sport') ? 'bg-red-600 rounded-3xl px-4 py-2' : 'px-4 py-2 text-nowrap'" to="/sport">
            <span class="text-white text-xs md:text-md line-clamp-1 !text-nowrap">Sport</span>
        </RouterLink>
        <RouterLink @click="handleNavClick('/tv-film')"
            :class="activeRoute.includes('/tv-film') ? 'bg-red-600 rounded-3xl px-4 py-2' : 'px-4 py-2 text-nowrap'" to="/tv-film">
            <span class="text-white text-xs md:text-md line-clamp-1 !text-nowrap">TV & Film</span>
        </RouterLink>
        <RouterLink @click="handleNavClick('/music')"
            :class="activeRoute.includes('/music') ? 'bg-red-600 rounded-3xl px-4 py-2' : 'px-4 py-2 text-nowrap'" to="/music">
